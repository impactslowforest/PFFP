...
var PFFP_DB = (function () {
    ...
    var STORES = {
        ...
        'op6_activities_list':    { keyPath: null, keyCol: 'OP6 ID' },
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.onupgradeneeded = function (e) {
                ...
                existing.forEach(function (name) {
                    try { database.deleteObjectStore(name); } catch (err) { console.warn('Delete store failed:', name, err); }
                });
                Object.keys(STORES).forEach(function (storeName) {
                    ...
                    } catch (err) { console.warn('Delete store failed:', storeName, err); }
                    try {
                    ...
                    } catch (err) { console.error('Create store failed:', storeName, err); }
                });
            };
